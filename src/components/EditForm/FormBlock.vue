   ...
   export default {
      ...
      methods: {
        ...
        is_default_full_str(field){
          ...
          return (typeof(field.full_str)=='undefined' && /^(password|date|file|time|datetime|memo|wysiwyg|1_to_m|text|checkbox|select|switch|textarea|multiconnect)$/.test(field.type));
        },
